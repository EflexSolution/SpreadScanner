// src/lib.rs
/*
 * Core library for SpreadScanner
 */
...
#[derive(Debug)]
pub struct SpreadScannerProcessor {
    verbose: bool,
    processed_count: usize,
}

impl SpreadScannerProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting SpreadScanner processing");
    
    let mut processor = SpreadScannerProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = SpreadScannerProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = SpreadScannerProcessor::new(false);
